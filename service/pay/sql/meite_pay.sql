...
-- ----------------------------
INSERT INTO `payment_channel` VALUES ('1', '银联支付', 'yinlian_pay', '777290058110048', 'http://www.coship.com', 'http://70817152.ngrok.io/unionPayAsynCallback', null, null, '0', 'com.lipeng.pay.strategy.impl.UnionPayStrategy', null, null, null, null, null);
...
CREATE TABLE `payment_transaction` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='支付交易 ';

package com.lipeng.weixin.mp.handler;

import com.lipeng.base.BaseResponse;
import com.lipeng.constants.Constants;
import com.lipeng.core.utils.RedisUtil;
import com.lipeng.core.utils.RegexUtils;
import com.lipeng.member.dto.UserOutDTO;
import com.lipeng.weixin.feign.MemberServiceFeign;
import com.lipeng.weixin.mp.builder.TextBuilder;
...
public class MsgHandler extends AbstractHandler {
	// 用户发送手机验证码提示
	@Value("${lipeng.weixin.registration.code.message}")
	private String registrationCodeMessage;
	// 默认用户发送验证码提示
	@Value("${lipeng.weixin.default.registration.code.message}")
